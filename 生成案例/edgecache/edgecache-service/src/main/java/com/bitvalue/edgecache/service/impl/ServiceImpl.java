...
import com.bitvalue.edgecache.dao.BaseDao;
        ...
        return new Specification<T>() {
            ...
            public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                ...
                if (criteria.getParams() != null) {
                    BeanUtil.beanToMap(criteria.getParams(), map, false, true);
                }
                ...
                if (entries != null) {
                    for (Map.Entry<String, Object> entry : entries) {
                        ...
                        if (value instanceof String) {
                            ...
                            // TODO: 2020/08/06  predicateList.add(cb.equal(root.get(key).as(String.class), entry.getValue()));
                            predicateList.add(cb.equal(root.get(key), entry.getValue()));
                        }
                    }
                }
                Predicate[] p = new Predicate[predicateList.size()];
