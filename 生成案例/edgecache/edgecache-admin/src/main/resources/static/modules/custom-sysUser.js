	...
	table.render({
		...
		cols: [[
            ...
            /*{field: 'password', title: '密码',templet:function (d) {
				return "********" + "&nbsp;&nbsp;<i class='layui-icon layui-icon-tips'></i>"
            }},*/
            {field: 'enabled', title: '是否可用',templet:function (d) {
				return d.enabled ? "可用" : "不可用"
            }},
