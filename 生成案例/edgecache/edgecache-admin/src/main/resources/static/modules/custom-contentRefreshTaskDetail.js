/**
 @Name：ContentRefreshTaskDetail JS
 */
layui.define(['table', 'form'], function(exports) {
	var $ = layui.$,
		table = layui.table,
		form = layui.form,
		moduleUrl = "/content_refresh_task_detail/";
	table.render({
		elem: '#list-table',
		url: moduleUrl + 'page',
		method: 'post',
		...
		cols: [[
            ...
            /*{field: 'contentId', title: '主表ID'},*/
            {field: 'urlOrDirectory', title: '刷新内容'},
            /*{field: 'status', title: '成功 失败'},*/
	...
	exports('custom-contentRefreshTaskDetail', {})
});
