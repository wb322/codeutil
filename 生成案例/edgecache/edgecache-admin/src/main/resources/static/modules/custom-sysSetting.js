...
layui.define(['table', 'form'], function(exports) {
	...
	table.render({
		...
		cols: [[
            ...
            {field: 'control', title: '控制中心'},
            {field: 'license', title: 'License有效期'},
            {field: 'pack', title: '系统安装包'},
            {field: 'cdn', title: '是否为CDN模式'},
