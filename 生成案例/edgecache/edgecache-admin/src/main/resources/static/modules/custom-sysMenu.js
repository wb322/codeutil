...
layui.define(['table', 'form'], function(exports) {
	...
	table.render({
		...
		cols: [[
            ...
            {field: 'pid', title: '上级',templet:function (d) {
				return d.parentName == null ? "":d.parentName;
            }},
            {field: 'icon', title: '图标'},
				...
				yes: function(index, layero) {
					...
					iframeWindow.layui.form.on('submit(form-edit-submit)', function(formData) {
						...
						$.each(resultData, function(k, v) {
							if (v == (data[k] == null ? null:data[k].toString()) && k != 'id') {
								delete resultData[k];
							}
						});
