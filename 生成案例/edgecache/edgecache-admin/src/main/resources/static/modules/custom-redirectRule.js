/**
 @Name：RedirectRule JS
 */
layui.define(['table', 'form'], function(exports) {
	var $ = layui.$,
		table = layui.table,
		form = layui.form,
		moduleUrl = "/redirect_rule/";
	...
	var tableConfig = {
		...
		cols: [[
			...
			{field: 'id', title: '规则Id',width:150},
			{field: 'rosterType', title: '类型',width:150,templet:function (d){
				return d.rosterType == 1? "白名单":"黑名单"
			}},
			{field: 'rule', title: '匹配规则'},
			{field: 'vhost', title: 'vhost'},
			{field: 'ips', title: '重定向IP'},
	...
	function add(){
		layer.open({
			type: 2,
			title: '添加',
			content: '/menu/redirect_rule/form',
			maxmin: true,
			area: ['550px', '550px'],
			btn: ['确定', '取消'],
