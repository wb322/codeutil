...
layui.define(['table', 'form'], function(exports) {
	...
	table.render({
		...
		cols: [[
            ...
            {field: 'id', title: 'id'},
            {field: 'ip', title: '机器IP'},
            {field: 'cpu', title: 'CPU使用率'},
            {field: 'memoryTotal', title: '总内存'},
            {field: 'memoryUsed', title: '已使用内存'},
            {field: 'memoryRate', title: '内存使用率'},
            {field: 'diskTotal', title: '总磁盘大小'},
            {field: 'diskUsed', title: '已使用磁盘大小'},
            {field: 'diskRate', title: '磁盘使用率'},
            {field: 'time', title: '时间'},
