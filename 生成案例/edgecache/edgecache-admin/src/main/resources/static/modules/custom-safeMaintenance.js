/**
 @Name：SafeMaintenance JS
 */
layui.define(['table', 'form'], function(exports) {
	var $ = layui.$,
		table = layui.table,
		form = layui.form,
		moduleUrl = "/safe_maintenance/";
	table.render({
		elem: '#list-table',
		url: moduleUrl + 'page',
		method: 'post',
		...
		cols: [[
            ...
            {field: 'id', title: 'id'},
            {field: 'ip', title: 'IP或网段'},
            {field: 'auth', title: '权限',templet:function (d){return d.auth + "连接"}},
	...
	exports('custom-safeMaintenance', {})
});
